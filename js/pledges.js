...
const CLS_NAME_ONLY =
  "col-caller col-3 col-lg-2 col-offset-right-9 col-lg-offset-right-10";
...
const CLS_NAME_ONLY_2 =
  "col-caller col-6 col-lg-4 col-offset-right-6 col-lg-offset-right-8";
...
function outputBoard(settings) {
  ...
  function getRow(caller, settings) {
    ...
    if (caller.pledges.length === 0) {
      ...
      colName.className = settings.two_col
        ? CLS_NAME_WITH_PL_2
        : CLS_NAME_WITH_PL;
      colPledges.className = settings.two_col
        ? CLS_PLEDGES_WITH_PL_2
        : CLS_PLEDGES_WITH_PL;
